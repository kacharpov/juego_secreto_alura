...
function generarNumeroSecreto() {
    ...
    /*Si ya salieron todos los números*/

    if (listNumSort.length == numMaximo){
        asignarTextoElemento('p', 'Ya salieron todos los números posibles')
    } else{
        if (listNumSort.includes(numeroGenerado)){
            return generarNumeroSecreto();
        } else { /*Regresa a generar otro num secreto*/
        listNumSort.push(numeroGenerado); /*Agrego el num al arreglo*/
